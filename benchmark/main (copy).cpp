...
int main(int argc, char* argv[]) {
  ...
  //myOCR->SetPageSegMode(tesseract::PSM_SINGLE_LINE);
  // read iamge
  ...
  Rect text1ROI(0, 0, 100, 1000);
  Rect text2ROI(500, 1000, 200, 200);
  ...
  //const char *text1 = myOCR->GetUTF8Text();
	const char *text1 = myOCR->GetBoxText(0);
cout<<text1<<endl;
//printf(text1);
